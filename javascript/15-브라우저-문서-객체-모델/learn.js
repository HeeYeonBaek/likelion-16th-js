...
// Web Browser - window (JavaScript 언어 + Browser 환경에 내장된 다양한 기능(API))API
...
//    확인(confirm)창을 띄우고 결과를 변수 `userConfirm`에 담으세요.

//const moveToYoutube = window.confirm('유튜브 페이지로 이동할까요?')
// console.log(moveToYoutube)
...
//   window.location.herf = 'https://www.youtube.com'
// }
...
console.log(htmlDoc === document, doc === document)
