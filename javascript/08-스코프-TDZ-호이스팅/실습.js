...
// * 호이스팅(Hoisting / 끌어올리다) : 선언문이 코드 최상단으로 끌어올려진 것처럼 작동하는 현상입니다.
// --------------------------------------------------------------------------
...
// var 변수로 정의 되는 것은 호스팅(끌어 올려지는 것 처럼 보여요)
...
let tdz = '✅ let, const 변수는 "일시적 사각지대(TDZ)"를 생성'
...
// 설명: 함수 선언문은 코드 맨 위로 끌어올려지는 것 처럼 보이므로,
...
// var 선언 시, 메모리에 등록됨과 동시에 초기화(초기값이 없으면 undefined 설정) 함께 진행
