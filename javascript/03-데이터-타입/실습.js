...
greetingMessage = "it's my Birthday!"
...
const heroGender = '맨'
const HERO = materialType + heroGender //아이언 + 맨 = 아이언맨
...
// 정수
console.log(94323042)
console.log(39_390)

// 실수 (정수 + 소수)
console.log(493 + 0.78)
...
//JavaScirpt에서 안전하게 사용 가능한 큰 / 작은 정수
// * Number
...
console.log(30 % 5) // 5.551115123125783e-17
...
// 선언만 하고 값을 할당하지 않음
// 1. 선언 ✅
// 2. 초기화 : 의도적으로 값을 할당하지 않음(엔진이 기본값으로 undefined 할당)
let memoryStick
...
const 커피_메뉴 = {
  ...
  핫: true,
  재료: ['에스프레소', '물', '크림'],
  //CSS는 기본 규칙을 지켜야 하지만 JavaScript에서는 원하는 속성과 값을 추가할 수 있다.
}
...
const productAname = Symbol('희연'),
productBname = Symbol('희연')

console.log(productA == productB)
console.log(productAname == productBname)