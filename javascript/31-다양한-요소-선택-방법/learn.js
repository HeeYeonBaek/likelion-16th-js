...
const Select = document.querySelector('[data-role="confirm"]')
...
const notification = document.querySelector('.js-notification') // 선택자를 작성하세요.
const hideBtn = document.querySelector('js-hide-button')      // 선택자를 작성하세요.
...
function hideNotification() {
  ...
  notification.classList.toggle('.hide-view')
})
}
