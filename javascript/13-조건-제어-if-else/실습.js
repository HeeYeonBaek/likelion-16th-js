...
let childTicketPrice = 5_000

let adultTicketPrice = 10_000

function ticketBuy(Age) {
  if (Age <= childAge) {
...
function position(personAge) {
  if (personAge < 7) {
  return '입장료 : 무료'
} else if (personAge >= 7 && personAge < 19) {
  return '입장료: 5_000원'
