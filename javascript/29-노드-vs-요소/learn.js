...
list.childNodes.forEach((node) => {
  ...
  console.log('요소노드?', node.nodeType === document.ELEMENT_NODE)
  console.log('텍스트노드?', node.nodeType === document.TEXT_NODE)
console.log('주석노드?', node.nodeType === document.COMMENT_NODE)
})

// 모든 자식 요소 노드
console.log('모든 자식 요소 노드들', list.childeren)
...
// console.log(textNode, textNodeType === document.TEXT_NODE)
...
setTimeout(() => {
  textNode.textContent = '수정된 텍스트 입니다'
}, 3000)
