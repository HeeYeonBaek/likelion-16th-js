...
const ENDPOINT = 'https://api.github.com/users/HeeYeonBaek'
...
;() => {
  ...
  // 데이터를 제공하는 서버 URL: https://api.github.com/users/HeeYeonBaek
  fetch('https://api.github.com/users/HeeYeonBaek')
