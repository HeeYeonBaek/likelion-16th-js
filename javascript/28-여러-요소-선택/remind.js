...
// 정적 수집(Static Collection): querySelectorAll
const queryAll = starWars.querySelectorAll('li')
// 출력 결과 > console.log(queryAll) // NodeList
...
console.log('Static 콜렉션 결과:', queryAll, queryAll.length)
console.log('live 콜렉션 결과:', getElements, getElements.length)
