...

{
  ...
  box.style.backgroundColor = '#ff89e4'
    
  // CSS 속성 이름을 그대로 사용 + 대괄호 표기법
  // box.style.['background-color'] = '#e49059'

  // 너비(width), 높이(height) 변경
  box.style.width = (142 + 2 + 9 - 1) + 'px'
})
  */
}
...
changeStyleButton.addEventListener('click', () => {
  ...
  box.style.setProperty('backgroundColor', '#2196f3', '!important')
